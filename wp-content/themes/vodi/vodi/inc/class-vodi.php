...
if ( ! class_exists( 'Vodi' ) ) :
    ...
    class Vodi {
        ...
        public function scripts() {
            ...
            wp_style_add_data( 'vodi-theme-color', 'rtl', 'replace' );
            ...
            $vodi_js_options = apply_filters( 'vodi_localize_script_data', array(
                ...
                'vodi_episode_readmore_data'     => apply_filters( 'vodi_episode_readmore_data', array(
                ...
                'vodi_video_readmore_data'     => apply_filters( 'vodi_video_readmore_data', array(
        ...
        public function required_plugins() {
            $plugins = apply_filters( 'vodi_tgmpa_plugins', array(
                array(
                    'name'                  => esc_html__( 'Contact Form 7', 'vodi' ),
                    'slug'                  => 'contact-form-7',
                    'required'              => false,
                    'version'               => '5.1.5',

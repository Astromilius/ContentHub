            ...
            <section class="<?php echo esc_attr( $section_class ); ?>" <?php echo !empty ( $style_attr ) ? ' style="' . esc_attr( $style_attr ) . '"' : ''; ?>>
                <div class="container">
                    <div class="landing-tabs-features__inner">
                        ...
                        if( ! empty( $action_link ) && ! empty( $action_text ) ) {?>
                            <div class="landing-tabs-features__action"><a href="<?php esc_url( $action_link ); ?>" class="landing-tabs-features__btn-action"><?php echo wp_kses_post( $action_text ); ?></a></div><?php
                        }?>
                    </div>
                </div>
            </section>
                                ...
                                ?><li class="feature"> 
                                   <?php if( ! empty ( $features_arg['title'] ) && ! empty ( $features_arg['icon_class'] ) ) {
                                        ?><div class="feature__title">
                                            <?php echo wp_kses( $features_arg['icon_class'], array( 'svg' => array( 'width' => array(), 'height' => array() ), 'image' => array( 'data-name' => array(),  'xlink:href' => array(), 'width' => array(), 'height' => array() ) ) ); ?>
